...
from experiments.income_census.train_census_dann_no_fg import create_global_model_wrapper
...
if __name__ == "__main__":
    ...
    # dann_task_id = '20201208_BCE_no_fg_0.0001_2'
    dann_task_id = '20201214_DEGREE_0.0008_128_1'
    ...
    plat_target.train_target_with_alternating(global_epochs=500, top_epochs=1, bottom_epochs=1, lr=lr,
