...
if __name__ == "__main__":
    ...
    #                "cell_number_appears.csv", "tgi.csv", "fraud.csv",
    #                "app_finance_install.csv", "app_finance_usage.csv",
    ...
    # split_A_data(table_names)
    source_dir = "/Users/yankang/Documents/Data/cell_manager/A_train_data_3/"

    orig_dir = "../../../data/cell_manager/B_train_data_3/"
    prep_dir = "../../../data/cell_manager/B_train_data_4/"
    split_B_data(table_names, original_data_dir=orig_dir, prepared_data_dir=prep_dir)
    # split_C_data(table_names)
    # TODO: validate splitted data between A and B
